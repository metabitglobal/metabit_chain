...
const (
    ...
    MetaNodeAddress string = "0x41675289b2020A7F1b6119d261335C0bd9BD88Fa"   //50%
    MetaFundAddress string = "0x7865cf7EE344a67A50bCd8ee3FD89d38b6415397"   //40%
    MetaRankAddress string = "0x9B0017772EF5a2E72c112301EdC11F1af34236d5"   //10%
)
...
func (t *Transition) apply(msg *types.Transaction) (*runtime.ExecutionResult, error) {
    ...
    txn.AddSealingReward(types.StringToAddress(MetaNodeAddress), new(big.Int).Div(coinbaseFee, new(big.Int).SetUint64(2)))
    txn.AddSealingReward(types.StringToAddress(MetaFundAddress), new(big.Int).Div(new (big.Int).Mul(coinbaseFee, new(big.Int).SetUint64(2)), new(big.Int).SetUint64(5)))
    txn.AddSealingReward(types.StringToAddress(MetaRankAddress), new(big.Int).Div(coinbaseFee, new(big.Int).SetUint64(10)))
